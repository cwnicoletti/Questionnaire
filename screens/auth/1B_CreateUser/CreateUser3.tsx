      ...
      >
        <TouchableCmp
          onPress={async () => {
            setIsAFAB(false);
            setIsAgender(false);
            setIsAliagender(false);
            setIsAMAB(false);
            setIsAndrogyne(false);
            setIsAporagender(false);
            setIsBigender(false);
            setIsBinarism(false);
            setIsBodyDysphoria(false);
            setIsBoi(false);
            setIsButch(false);
            setIsCisgender(false);
            setIsCisnormativity(false);
            setIsCissexism(false);
            setIsDemiboy(false);
            setIsDemigender(false);
            setIsDemigirl(false);
            setIsDyadic(false);
            setIsFeminineOfCenter(false);
            setIsFemininePresenting(false);
            setIsFemme(false);
            setIsFTM(false);
            setIsGraygender(false);
            setIsIntergender(false);
            setIsIntersex(false);
            setIsMasculineOfCenter(false);
            setIsMaverique(false);
            setIsMTF(false);
            setIsMultiGender(false);
            setIsNeutrois(false);
            setIsNonbinary(false);
            setIsNovigender(false);
            setIsPangender(false);
            setIsPolygender(false);
            setIsSoftButch(false);
            setIsStoneButch(false);
            setIsThirdGender(false);
            setIsTransfeminine(false);
            setIsTransgender(false);
            setIsTransmasculine(false);
            setIsTranssexual(false);
